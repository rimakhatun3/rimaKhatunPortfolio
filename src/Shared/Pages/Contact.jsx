    ...
    return (
        <div id="contact">
            ...
            <form  ref={form} onSubmit={sendEmail} className='w-full mx-auto space-y-3   px-8 py-8' >
               ...
               <input className=' w-full text-stone-700 px-4 border-orange-600  border-4 rounded-xl py-2' placeholder='Name' type="text"  name="user_name" id="" />
               </div>
               <div className='w-full lg:w-2/4 mx-auto'>
               
               <input className='border-orange-600  border-4 w-full px-4 text-stone-700 rounded-xl py-2' placeholder='Email' type="text"  name="user_email" id="" />
               </div>
               <div className='w-full lg:w-2/4 mx-auto'>
                
               <textarea placeholder='Message ' className='w-full border-orange-600  border-4 text-stone-700 px-5 py-3 rounded-xl' name="message" id="" cols="15" rows="5"></textarea>
               </div>
